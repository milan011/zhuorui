...
class ConfigComposer {
	...
	public function compose(View $view) {
		...
		$package_year     = config('zhuorui.package_year'); //获取配置文件套餐年配置
		...
		$info_dianxin_status = config('zhuorui.info_dianxin_status'); //获取配置文件电信信息状态配置
		...
		$view->with('info_dianxin_status', $info_dianxin_status);
	}
}